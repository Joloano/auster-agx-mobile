...
const mobileModuleCatalog = <MobileModuleDefinition>[
  ...
  MobileModuleDefinition(
    id: AppModuleId.mapeamento,
    title: 'Mapeamentos',
    subtitle: 'Voos, satélites e imagens processadas',
    path: '/modulos/mapeamento',
  ...
  MobileModuleDefinition(
    id: AppModuleId.auditoria,
    title: 'Auditoria',
    subtitle: 'Histórico completo de alterações',
    path: '/modulos/auditoria',
    icon: Icons.fact_check_rounded,
    section: 'Administração',
  ),
  MobileModuleDefinition(
    id: AppModuleId.ajuda,
    title: 'Ajuda',
